...
<section>
    ...
    <form method="post" action="/meals/filter">
        <dl>
            <dt><spring:message code="meal.fDate"/>:</dt>
            <dd><input type="date" name="startDate" value="${param.startDate}"></dd>
        </dl>
        <dl>
            <dt><spring:message code="meal.tDate"/>:</dt>
            <dd><input type="date" name="endDate" value="${param.endDate}"></dd>
        </dl>
        <dl>
            <dt><spring:message code="meal.fTime"/>:</dt>
            <dd><input type="time" name="startTime" value="${param.startTime}"></dd>
        </dl>
        <dl>
            <dt><spring:message code="meal.tTime"/>:</dt>
            <dd><input type="time" name="endTime" value="${param.endTime}"></dd>
        </dl>
        <button type="submit">
            <dt><spring:message code="meal.filter"/></dt>
        </button>
    </form>
    <hr/>
    <a href="/meals/create">
        <dt><spring:message code="meal.addMeal"/></dt></a>
    <hr/>
